...
const validate = combineValidators({
  ...
  newPassword2: composeValidators(
    isRequired({ message: "Reconfirm Password is required field" }),
  ...
  return <Segment>
      ...
      {providerId && providerId === "password" && (<div>
            ...
            <Form onSubmit={handleSubmit(updatePassword)}>
              ...
              <Divider />
              <Button disabled={invalid || submmitting} size="large" positive content="Update Password" />
            </Form>
          </div>)}
      {providerId && providerId === "facebook" && (<div>
